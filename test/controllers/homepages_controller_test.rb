...
class HomepagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create homepage" do
    assert_difference("Homepage.count") do
      post homepages_url, params: { homepage: { bbutton: @homepage.bbutton, bdheader1: @homepage.bdheader1, bdheader2: @homepage.bdheader2, bheader1: @homepage.bheader1, bheader2: @homepage.bheader2 } }
    end
  ...
  test "should update homepage" do
    patch homepage_url(@homepage), params: { homepage: { bbutton: @homepage.bbutton, bdheader1: @homepage.bdheader1, bdheader2: @homepage.bdheader2, bheader1: @homepage.bheader1, bheader2: @homepage.bheader2 } }
