...
class FeaturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create feature" do
    assert_difference("Feature.count") do
      post features_url, params: { feature: { name: @feature.name, realestate_id: @feature.realestate_id, value: @feature.value } }
    end
  ...
  test "should update feature" do
    patch feature_url(@feature), params: { feature: { name: @feature.name, realestate_id: @feature.realestate_id, value: @feature.value } }
